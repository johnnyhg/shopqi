...
"Shop Admin @ http://lvh.me:8080/user_root":http://lvh.me:8080/user_root
...
bq. 
flexibility to change fields, no need to manage migration, better management of many relationship
...
The official version 1.0.0-rc3 has two problems: 
1. Unable to use jquery-1.4.2, you can manually fix;
2. Call destroy method will report 'state undefined error'
...
# Add gtalk account to get direct communication: mahb45 # gmail.com
