...
sudo apt-get install build-essential bison openssl libreadline6 libreadline-dev curl git-core graphicsmagick zlib1g zlib1g-dev libssl-dev vim libsqlite3-0 libsqlite3-dev sqlite3 libxml2-dev subversion autoconf ruby ruby-dev
#webrat插件所需
